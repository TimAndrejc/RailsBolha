...
class ConvosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create convo" do
    assert_difference("Convo.count") do
      post convos_url, params: { convo: { user_id: @convo.user_id, post_id: @convo.post_id } }
    end
  ...
  test "should update convo" do
    patch convo_url(@convo), params: { convo: { user_id: @convo.user_id, post_id: @convo.post_id } }
